...
export default function DLFPrivanaWestPage() {
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="w-full px-6 pb-16 text-white md:px-12">
            <div className="mx-auto max-w-7xl">
              <p className="text-sm uppercase tracking-wider text-white/80">Sector 76-77, Gurgaon</p>
              <h1 className="mt-2 font-serif text-5xl md:text-7xl">DLF Privana West</h1>
              <p className="mt-4 text-xl">Luxury Residential Apartments by DLF</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16 md:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-6 text-lg leading-8 text-[var(--muted)]">
            DLF Privana West is a premium residential project by DLF Limited, one of India's most trusted real estate developers. 
            Located in Sector 76-77, Gurgaon, this project offers spacious 4 BHK apartments designed with contemporary architecture 
            and world-class amenities. The development is strategically positioned to provide excellent connectivity to major business 
            districts, educational institutions, and healthcare facilities.
          </p>
          <p className="mt-4 text-lg leading-8 text-[var(--muted)]">
            DLF Privana West represents the perfect blend of luxury and comfort, featuring meticulously planned residences with 
            premium specifications, modern amenities, and lush green landscapes. The project is designed to offer a lifestyle that 
            combines convenience with elegance, making it an ideal choice for discerning homebuyers.
          </p>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="border-l-4 border-[var(--accent)] bg-[#f7f1e8] p-6">
              ...
              <p className="mt-2 text-[var(--muted)]">1895 - 3800 sq.ft.</p>
            </div>
            <div className="border-l-4 border-[var(--accent)] bg-[#f7f1e8] p-6">
              <h3 className="font-serif text-2xl text-[var(--foreground)]">Price Range</h3>
              <p className="mt-2 text-[var(--muted)]">₹3.5 Cr - ₹7 Cr</p>
            </div>
            <div className="border-l-4 border-[var(--accent)] bg-[#f7f1e8] p-6">
              <h3 className="font-serif text-2xl text-[var(--foreground)]">Location</h3>
              <p className="mt-2 text-[var(--muted)]">Sector 76-77, Gurgaon</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div>
              ...
              <ul className="mt-4 space-y-3 text-[var(--muted)]">
                <li>• Close proximity to NH-8 and Southern Peripheral Road</li>
                <li>• 20 minutes from IGI Airport</li>
                <li>• Easy access to Cyber City and Golf Course Road</li>
                <li>• Well-connected to Delhi via multiple routes</li>
              </ul>
            </div>
            <div>
      ...
      <section className="bg-[#18120f] px-6 py-16 text-white md:px-12">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-white/80">
            Experience the luxury of DLF Privana West firsthand. Contact us to schedule your personal site visit.
          </p>
