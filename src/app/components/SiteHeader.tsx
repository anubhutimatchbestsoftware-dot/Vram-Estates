  ...
  return (
    <>
      <header className={`fixed inset-x-0 top-0 z-30 ${isTransparent ? "bg-transparent" : "bg-black/80 backdrop-blur-md"}`}>
        <div className="relative mx-auto flex w-full max-w-[1800px] items-center justify-between px-5 py-5 text-white md:px-12 md:py-6">
          <button
            type="button"
          ...
          <Link href="/" className="absolute left-1/2 flex -translate-x-1/2 items-center gap-2 md:static md:translate-x-0 md:gap-4">
            ...
            <div className="leading-tight">
              <p className="whitespace-nowrap text-[17px] font-semibold tracking-tight md:text-[18px]">VRAM Estates</p>
              <p className="hidden text-[12px] text-white/80 md:block">Luxury Property Consultants</p>
            </div>
          </Link>

          <nav className="absolute left-1/2 hidden -translate-x-1/2 items-center gap-10 text-[16px] font-medium text-white/90 md:flex">
